...
// 获取总记录数
$sql = "SELECT COUNT(*) AS total FROM article WHERE board = '轉系板'";
$result = $conn->query($sql);
$total = $result->fetch_assoc()['total'];
$total_pages = ceil($total / $limit); // 總頁數

// 獲取數據
$sql = "SELECT * FROM article where board='轉系板'ORDER BY upload_date DESC LIMIT $limit OFFSET $offset";
